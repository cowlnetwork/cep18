...
pub const ENTRY_POINT_AUTHORIZATION_STATE: &str = "authorization_state";
pub const ENTRY_POINT_TRANSFER_WITH_AUTHORIZATION: &str = "transfer_with_authorization";
pub const ENTRY_POINT_RECEIVE_WITH_AUTHORIZATION: &str = "receive_with_authorization";
pub const ENTRY_POINT_PERMIT: &str = "permit";

pub const ARG_ADDRESS: &str = "address";
pub const ARG_AMOUNT: &str = "amount";
pub const ARG_AUTHORIZER: &str = "authorizer";
pub const ARG_CHAIN_NAME: &str = "chain_name";
...
pub const ARG_VALID_AFTER: &str = "valid_after";
pub const ARG_VALID_BEFORE: &str = "valid_before";
...
pub const DICT_USED_AUTHORIZATION_NONCES: &str = "used_authorization_nonces";
pub const DICT_PERMIT_NONCES: &str = "permit_nonces";
pub const KEY_GASLESS_CHAIN_NAME: &str = "gasless_chain_name";
/*  */
